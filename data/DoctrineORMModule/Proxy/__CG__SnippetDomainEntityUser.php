 ...
 */
class User extends \SnippetDomain\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'SnippetDomain\\Entity\\User' . "\0" . 'userId', '' . "\0" . 'SnippetDomain\\Entity\\User' . "\0" . 'email', '' . "\0" . 'SnippetDomain\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'SnippetDomain\\Entity\\User' . "\0" . 'surname', '' . "\0" . 'SnippetDomain\\Entity\\User' . "\0" . 'picture', '' . "\0" . 'SnippetDomain\\Entity\\User' . "\0" . 'favorites');
        }
     ...
     * {@inheritDoc}
     */
    public function setFavorites(\Doctrine\Common\Collections\ArrayCollection $favorites)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFavorites', array($favorites));
